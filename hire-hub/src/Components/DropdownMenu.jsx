        ...
        <nav className="popup-window">
          ...
          <ul>
            ...
            {user?.role === 'recruiter' ? (
              ...
              <li>
                <MenuLink bootstrapIcon={ "bi bi-bookmark" } linkName={ "bookmarks" } />
              </li>
              </>
            )}
            <hr />
...
const StyledWrapper = styled.div`
  ...
  .popup {
    ...
    --nav-border-color: #00C1BD;
    --nav-border-width: 0.0625em;
    --nav-shadow-color: rgba(5, 67, 122, 0.15);
    ...
    --nav-default-scale: .8;
    --nav-active-scale: 1;
    --nav-position-left: auto;
    --nav-position-right: 0;
    /* if you want to change sides just switch one property */
    /* from properties to "unset" and the other to 0 */
    /* title */
    --nav-title-size: 0.625em;
    --nav-title-color: #536B82;
    ...
    --nav-button-hover-bg: #00C1BD;
    --nav-button-hover-text-color: #fff;
    --nav-button-distance: 0.875em;
    /* underline */
    --underline-border-width: 0.0625em;
    --underline-border-color: #00C1BD;
